...
for folders in eq_folder:
    ...
    for factors in scale_factor:
        ...
        name_list = []
        while pos < 5:
            locals()['position' + str(pos) + '_com'] = "'XSTART = 0.333333 YSTART = -1.5 ZSTART = 0 XEND = 0.333333 YEND = 1.5 ZEND = 0 NUMPTS = 200 EXTRACTTHROUGHVOLUME = F EXTRACTTOFILE = T EXTRACTFILENAME = " + "\\'" + dir_position  + "\\POSITION" + str(pos) + ".txt\\' '"
