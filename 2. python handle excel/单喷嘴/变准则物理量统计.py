...
scale_factor = [0.5, 0.7, 1]
# 定义统计物理量的目录以及建立统计表
for swirl in swirl_folder:
    # 地址格式举例：F:\\PhD\\1 nozzle\\eq\\postprocessing\\eq=0.55
    dir_colletion = 'E:\\0-PhD\\1 nozzle\\re\\postprocessing\\z-' + swirl
...
# 定义导出数据的范围
        ...
        app_ori.quit()
# 保存文件
    saveplace = dir_colletion+ '\\' + head_dic[action_str_int] + "-re.xlsx"
    wb_collection.save(saveplace)
    app_col.quit()
